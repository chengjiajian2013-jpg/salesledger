...
CREATE INDEX idx_fenghua_entries_date ON fenghua_entries(date DESC);

CREATE TABLE fenghua_todos (
  id            INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE INDEX idx_fenghua_todos_status_due ON fenghua_todos(is_completed, due_date);
